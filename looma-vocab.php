...
<?php $page_title = 'Looma';
	...
	$masks = getMasks();
?>
	<link rel="stylesheet" type="text/css" href="css/looma-vocab.css">
	...
	<div id="main-container-horizontal">
		...
		<br>
		<div id="checkbox-row">
			<span id="flashcards-label">Flashcards: </span> <input type="checkbox" id="flashcards-box"></input>
			<br>
			<span id="word-game-label">Word Game: </span> <input type="checkbox" id="word-game-box"></input>
		</div>
	</div>
